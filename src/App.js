  ...
  render() {
    return (
      ...
      <Routes>
        ...
        <Route path="*" element={<div style={{textAlign: 'center', marginTop: '2rem'}}>404 - Page Not Found</div>} />
        {/* 404 fallback route */}
        <Route path="*" element={
          <div style={{textAlign: 'center', marginTop: '2rem', color: '#e74c3c', fontSize: '1.5rem'}}>
            Sorry buddy, this page does not exist.
          </div>
        } />
      </Routes>
      </BrowserRouter>
